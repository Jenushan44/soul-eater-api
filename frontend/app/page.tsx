    ...
    <div>
      ...
      <div className="w-full relative">
        ...
        <div className="absolute top-[50%] left-[2%]">
          <p className="font-semibold text-[#f89c0a] text-[15px] md:text-[20px] lg:text-[30px]">WELCOME TO THE</p>
          <p className="font-banner text-[60px] md:text-[80px] lg:text-[150px] leading-[0.8] mt-3">SOUL EATER</p>
          <p className="font-banner text-[60px] md:text-[80px] lg:text-[150px] leading-[0.8] text-[#f89c0a] mt-2 mb-2">DATABASE</p>
          <p className="font-semibold mb-5 max-w-[500px] text-[15px] md:text-[18px] lg:text-[20px]">Explore the world of Soul Eater. Characters, Weapons, Abilities, Organizations and Arcs.</p>
